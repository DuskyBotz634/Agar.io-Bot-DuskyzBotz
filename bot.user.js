...
$.get('https://raw.githubusercontent.com/DuskyzBotz634/Agar.io-bot/master/bot.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
    ...
    {
        update("DuskyzBotz", "bot.user.js", "https://github.com/DuskyzBotz634/Agar.io-bot/blob/master/bot.user.js/");
    }
...
console.log("Running DuskyzBotz634 Bot!");
(function(f, g) {
    var splitDistance = 710;
    console.log("DuskyzBotz634 Bot!");
    ...
    f.botList.push(["DuskyzBotz " + GM_info.script.version, findDestination]);

    var bList = g('#bList');
    g('<option />', {value: (f.botList.length - 1), text: "DuskyzBotz"}).appendTo(bList);
